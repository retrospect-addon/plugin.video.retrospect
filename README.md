...
Starting from Kodi Leia (v18) playback of DRM protected streams is supported using the `InputStream Adaptive` add-on which is in the official Kodi repository. 
