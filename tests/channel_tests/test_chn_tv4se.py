...
class TestTv4Channel(ChannelTest):
    ...
    def test_tv_show_list(self):
        # url = "https://www.tv4play.se/alla-program"
        # Don't use the GraphQL for now.
        url = "https://graphql.tv4play.se/graphql?query=query%7BprogramSearch(per_page%3A1000)%7B__typename%2Cprograms%7B__typename%2Cdescription%2CdisplayCategory%2Cid%2Cimage%2Cimages%7Bmain16x9%7D%2Cname%2Cnid%2Cgenres%7D%2CtotalHits%7D%7D"
    ...
    def test_list_with_paging(self):
        ...
        self.assertGreaterEqual(len(items), 101)
